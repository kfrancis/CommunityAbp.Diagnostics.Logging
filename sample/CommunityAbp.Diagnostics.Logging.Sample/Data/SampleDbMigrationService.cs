...
public class SampleDbMigrationService : ITransientDependency
{
    ...
    private readonly SampleDbSchemaMigrator _dbSchemaMigrator;
    private readonly ICurrentTenant _currentTenant;

    public SampleDbMigrationService(
        IDataSeeder dataSeeder,
        SampleDbSchemaMigrator dbSchemaMigrator,
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "CommunityAbp.Diagnostics.Logging.Sample");
    }
